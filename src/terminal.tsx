...
export const Terminal = ({
  ...
  const content = (
    <div
      ref={containerRef}
      className={cn(
        // Adapted for Tailwind v4 (no shadcn background/border tokens here):
        // concrete console-dark surface instead of `bg-background border-border`.
        "z-0 h-full max-h-100 w-full max-w-lg rounded-xl border border-white/10 bg-[#0d1117] text-slate-100",
        className,
      )}
    >
